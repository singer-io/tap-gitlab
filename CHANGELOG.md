...
# 1.2.0
  * Streams the credentials cannot access (403) are now excluded from the catalog during discovery instead of raising an error.[#52](https://github.com/singer-io/tap-gitlab/pull/52)
